...
class EnemyLogic:
    ...
    def spawn_pattern(self, tower):
        if self.enemy_spawn_timer > 70:  # Every 1.5 seconds
            # tower.block.append(Block(tower.rect.left - Dimensions.BLOCK_SIZE1, Resolution.HEIGHT - 200 - Dimensions.BLOCK_SIZE1 // 2, -5))
            mobs = [Centipede(tower.rect.left - Dimensions.BLOCK_SIZE1, Resolution.HEIGHT - 250 - Dimensions.BLOCK_SIZE1 // 2), BigBloated(tower.rect.left - Dimensions.BLOCK_SIZE1,
